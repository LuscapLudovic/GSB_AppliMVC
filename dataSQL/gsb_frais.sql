...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 20 déc. 2018 à 11:27
...
('', '201812', 0, '0.00', '2018-12-14', 'CR'),
('c3', '201810', 0, '0.00', '2018-11-02', 'CL'),
('c3', '201811', 0, '0.00', '2018-12-12', 'CL'),
('c3', '201812', 0, '0.00', '2018-12-12', 'CR');
...
CREATE TABLE `groupes` (
  `id` int(4) NOT NULL,
  `libelle` varchar(255) NOT NULL DEFAULT 'visiteur'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `visiteur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateembauche`, `groupe_id`) VALUES
('', 'dark', 'sasuke', 'admin', 'pwsio', 'rue cool', '75000', 'Paris', '2018-12-01', 1),
...
--
ALTER TABLE `visiteur`
  ADD CONSTRAINT `visiteur_ibfk_1` FOREIGN KEY (`groupe_id`) REFERENCES `groupes` (`id`);
COMMIT;
